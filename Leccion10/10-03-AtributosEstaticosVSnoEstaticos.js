...
class Persona { //clase
    ...
    email = 'Valor default email';      //atributo sin ser declarado en constructor(atributo de nuestros objetos)
...
console.log(empleado1.email);  //atributo no estatico
console.log(Persona.email);  //no se pueden acceder los atributos estaticos mediante una clase
